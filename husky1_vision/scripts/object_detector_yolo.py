...
im_pil = None
model_def = "/home/developer/costar_husky_1/src/husky1_vision/scripts/config/yolov3-custom.cfg";
img_size = 416;
weights_path = "/home/developer/costar_husky_1/src/husky1_vision/scripts/checkpoints/yolov3_ckpt_99.pth";
conf_thres = 0.8;
class_path = "/home/developer/costar_husky_1/src/husky1_vision/scripts/data/custom/classes.names";
nms_thres = 0.4;
...
def init_model():
    ...
    #parser.add_argument("--model_def", type=str, default = "/home/developer/costar_husky_1/src/husky1_vision/scripts/config/yolov3-custom.cfg", help="path to model definition file")
    #parser.add_argument("--img_size", type=int, default = 416, help="shape of i/p image")
    #parser.add_argument("--weights_path", type=str, default = "/home/developer/costar_husky_1/src/husky1_vision/scripts/checkpoints/yolov3_ckpt_99.pth", help="paths to weight file")
    #parser.add_argument("--conf_thres", type=float, default=0.8, help="object confidence threshold")
    #parser.add_argument("--class_path", type=str, default="/home/developer/costar_husky_1/src/husky1_vision/scripts/data/custom/classes.names", help="path to class label file")
...
def inference(orig_img, img, model, classes):
    ...
    if detections is not None:
        detections = rescale_boxes(detections, img_size, np.array(orig_img).shape[:2])
        #print(detections)
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        detected_artifact = inference(im_pil, trans_img, model, classes)
