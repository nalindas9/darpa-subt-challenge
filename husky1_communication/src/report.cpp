...
int main(int argc, char **argv){
    ...
    // Hashmap for storing neighbour value
    std::map<std::string, std::pair<double, double>> neighbour_info;
    /*
      {
    TYPE_BACKPACK = 0,
    TYPE_DUCT,
    ...
    */
    ...
    // Get map of neighbour addresses and signal strength from local neighbours
    neighbour_info = commsClient.Neighbors();
    ROS_INFO_STREAM("Neighbor info key 1: " << neighbour_info.begin()->first);
    ros::spin();
    return 0;
}
