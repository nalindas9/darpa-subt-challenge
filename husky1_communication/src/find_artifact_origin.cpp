/*
Finding location of the Robot in reference to the Arifact origin frame

Reference:
1. https://github.com/osrf/subt_hello_world/blob/master/subt_solution_launch/src/find_artifact_origin.cpp
